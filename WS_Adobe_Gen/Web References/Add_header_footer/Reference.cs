...
namespace WS_Adobe_Gen.Add_header_footer {
    using System;
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="Add_header_footerSoapBinding", Namespace="http://adobe.com/idp/services")]
    public partial class ETR_Add_header_footerService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public ETR_Add_header_footerService() {
            this.Url = global::WS_Adobe_Gen.Properties.Settings.Default.WS_Adobe_Gen_Add_header_footer_ETR_Add_header_footerService;
        ...
        public BLOB invoke(BLOB DocIn, string ISDS, string cj, string document_id, string ext_typ, string kraj_kod, string oec, out string err_txt) {
            object[] results = this.Invoke("invoke", new object[] {
                        ...
                        kraj_kod,
                        oec});
            err_txt = ((string)(results[1]));
            return ((BLOB)(results[0]));
        }
        
        /// <remarks/>
        public void invokeAsync(BLOB DocIn, string ISDS, string cj, string document_id, string ext_typ, string kraj_kod, string oec) {
            this.invokeAsync(DocIn, ISDS, cj, document_id, ext_typ, kraj_kod, oec, null);
        }
        
        /// <remarks/>
        public void invokeAsync(BLOB DocIn, string ISDS, string cj, string document_id, string ext_typ, string kraj_kod, string oec, object userState) {
            ...
            this.InvokeAsync("invoke", new object[] {
                        ...
                        ext_typ,
                        kraj_kod,
                        oec}, this.invokeOperationCompleted, userState);
        }
