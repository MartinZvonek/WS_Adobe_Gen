...
namespace WS_Adobe_Gen.Add_watermark {
    using System;
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="Add_watermarkSoapBinding", Namespace="http://adobe.com/idp/services")]
    public partial class ETR_Add_watermarkService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public ETR_Add_watermarkService() {
            this.Url = global::WS_Adobe_Gen.Properties.Settings.Default.WS_Adobe_Gen_Add_watermark_ETR_Add_watermarkService;
        ...
        public BLOB invoke(BLOB DocIn, string Watermark_text_1, string Watermark_text_2, out string err_txt) {
        ...
        /// <remarks/>
        public void invokeAsync(BLOB DocIn, string Watermark_text_1, string Watermark_text_2) {
            this.invokeAsync(DocIn, Watermark_text_1, Watermark_text_2, null);
        }
        
        /// <remarks/>
        public void invokeAsync(BLOB DocIn, string Watermark_text_1, string Watermark_text_2, object userState) {
            ...
            this.InvokeAsync("invoke", new object[] {
                        DocIn,
                        Watermark_text_1,
                        Watermark_text_2}, this.invokeOperationCompleted, userState);
        }
